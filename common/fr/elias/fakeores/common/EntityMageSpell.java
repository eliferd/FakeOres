...
public class EntityMageSpell extends EntityCreature 
{
	...
	public void onLivingUpdate()
	{
        ...
        Object obj = null;
        List list = worldObj.getEntitiesWithinAABBExcludingEntity(this, boundingBox.addCoord(motionX, motionY, motionZ).expand(2.0D, 2.0D, 2.0D));
        double d = 0.0D;
        ...
        for (int i = 0; i < list.size(); i++)
        {
            ...
            d2 = boundingBox.minY + (double)(entity.height / 2.0F) - (this.posY + (double)(this.height / 2.0F));
