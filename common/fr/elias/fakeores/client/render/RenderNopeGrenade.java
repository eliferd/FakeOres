...
public class RenderNopeGrenade extends Render
{
    private Item field_94151_a;
    private int field_94150_f;

    public RenderNopeGrenade(RenderManager manager, Item par1, int par2)
    {
        super(manager);
    ...
    public RenderNopeGrenade(RenderManager manager, Item par1)
    {
        this(manager, par1, 0);
    }
    ...
    {
        return null;// TextureMap.locationItemsTexture;
    }
